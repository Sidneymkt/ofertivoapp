...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      offer_checkins: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "offer_checkins_qr_code_id_fkey"
            columns: ["qr_code_id"]
            isOneToOne: false
      ...
      raffles: {
        Row: {
          auto_participation: boolean | null
          business_id: string
          created_at: string
      ...
      ranking_semanal: {
        Row: {
          ...
          score_interacoes: number
          score_ofertas: number
          score_total: number
          updated_at: string
        }
        Insert: {
      ...
      user_missions_progress: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_missions_progress_mission_id_fkey"
            columns: ["mission_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      create_business_raffle_secure: {
        Args: {
          p_auto_participation: boolean
