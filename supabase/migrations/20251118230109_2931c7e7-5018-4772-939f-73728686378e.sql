-- Corrigir tipo de registro da função contribute_to_campaign para usar crowdfunding_campaigns
...
DECLARE
  ...
  v_campaign public.crowdfunding_campaigns%ROWTYPE;
BEGIN
  ...
  IF NOT p_is_anonymous AND v_campaign.creator_id != p_contributor_id THEN
    INSERT INTO public.notifications (
      ...
      (SELECT COALESCE(full_name, 'Um apoiador') FROM public.profiles WHERE user_id = p_contributor_id) || 
